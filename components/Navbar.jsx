        ...
        <nav className='navbar'>
          <Link to="pageHeader" spy={true} smooth={true} offset={0} duration={500}>
            ...
            <div className='navbarNav'>
                ...
                <a className={isScrolled?'items active':'items'} href="https://eng-resume.netlify.app">CV</a>
                <a className={isScrolled?'items active':'items'} href="https://kr-resume.netlify.app">이력서</a>
            </div>
